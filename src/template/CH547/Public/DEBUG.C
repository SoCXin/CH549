...
/*******************************************************************************
* Function Name  : CH547UART0Alter()
* Description    : CH547串口0引脚映射,串口映射到P0.2(R)和P0.3(T)
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
//void CH547UART0Alter()
//{
//	P0_MOD_OC |= (3<<2);                                                   //准双向模式
//	P0_DIR_PU |= (3<<2);
...
void mInitSTDIO( )
{
 ...
 /*******************************************************************************
 * Function Name  : CH547SoftReset()
 * Description    : CH547软复位
 * Input          : None
 * Output         : None
 * Return         : None
 *******************************************************************************/
...
//}
/*******************************************************************************
* Function Name  : CH547WDTModeSelect(UINT8 mode)
* Description    : CH547看门狗模式选择
...
* Return         : None
*******************************************************************************/
void CH547WDTModeSelect(UINT8 mode)
{
   SAFE_MOD = 0x55;
...
/*******************************************************************************
* Function Name  : CH547WDTFeed(UINT8 tim)
* Description    : CH547看门狗定时时间设置
